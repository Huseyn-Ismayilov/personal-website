...
const LinkItems = [
    {
        text: "Home",
        to: "/",
        icon: (<svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.70553 18.8827H16.2943C17.7239 18.8827 18.8826 17.724 18.8826 16.2944V8.12661C18.8826 7.16336 18.4091 6.26156 17.6162 5.71479L11.1632 1.26445C10.1619 0.573879 8.83795 0.573879 7.83646 1.26445L1.38362 5.71479C0.590662 6.26156 0.117188 7.16336 0.117188 8.12661V16.2944C0.117188 17.724 1.27607 18.8827 2.70553 18.8827Z" fill="currentColor"></path>        <path d="M11.9751 15.7442H7.48486" stroke="white" stroke-width="1.66667" stroke-linecap="round"></path>    </svg>)
    },
    {
        text: "About",
        to: "/about",
        ...
        <div className="fixed bottom-10 left-1/2 -translate-x-[50%] shadow-md">
            <div className="flex items-center gap-5 p-4 border border-gray-300 rounded-xl backdrop-blur-sm bg-white/60">
                {LinkItems.map((item, index) => (
                    ...
                    >
                        {({ isActive }) => (
                            <div className={`text-[#000000a8] flex items-center justify-center w-11 h-11 rounded-lg border border-transparent ${isActive ? "bg-gray-100 border-gray-200 hover:border-gray-200" : ""}`}>
                                {item.icon}
                            </div>
                        )}
                    </NavLink>
