...
export default function NavBar() {
    return (
        <div className="fixed bottom-10 left-1/2 -translate-x-[50%]">
            <div className="flex items-center gap-5 p-4 bg-white border border-gray-300 rounded-xl">
                ...
                <NavLink to="/" className="flex items-center justify-center w-10 h-10 bg-gray-500 rounded-lg">
